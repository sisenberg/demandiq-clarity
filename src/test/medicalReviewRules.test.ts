...
describe("Medical Review Rules", () => {
  ...
  it("flags high variance pricing in bill lines", () => {
    const highBillLine: ReviewerBillLine[] = [{
      ...
      service_date: "2024-12-01", service_date_end: null,
      cpt_code: "72141", hcpcs_code: null, icd_codes: [], modifiers: [],
      revenue_code: null, units: 1, billed_amount: 3200,
  ...
  it("bills without linked treatments are flagged", () => {
    const orphanBill: ReviewerBillLine[] = [{
      ...
      service_date: "2024-12-01", service_date_end: null,
      cpt_code: "99283", hcpcs_code: null, icd_codes: [], modifiers: [],
      revenue_code: null, units: 1, billed_amount: 2500,
